...
import { tipoAutenticacion } from "./auth/tipos.js";

const tiposGlobales = gql`
  scalar Date
`;

export const tipos = [tiposGlobales, tiposEnums, tiposAvance, tiposProyecto, tiposUsuario, tiposInscripcion, tipoAutenticacion];
